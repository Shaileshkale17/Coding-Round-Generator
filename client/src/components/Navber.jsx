  ...
  return (
    <div className="flex justify-between items-center py-4 px-6 bg-black text-white md:text-base text-sm">
      ...
      <div
        ...
        } md:flex flex-col md:flex-row gap-6 md:gap-8 md:relative absolute top-[4.5rem] right-0 md:top-0 md:right-0 bg-black md:bg-transparent z-50 md:z-auto   py-4 md:py-0 px-6 md:px-0 w-full md:w-auto left-0`}>
